namespace HouseProject.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BookingRecords", "HomeID", "dbo.Homes");
            DropForeignKey("dbo.Homes", "HomeTypeID", "dbo.HomeTypes");
            ...
            DropIndex("dbo.Homes", new[] { "HomeTypeID" });
            DropIndex("dbo.BookingRecords", new[] { "HomeID" });
